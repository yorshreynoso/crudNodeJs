...
// @TODO only let an authenticated user delete theri object. Dont let them delete any one else
...
handlers._users.delete = function(data, callback) {
    ...
    if(phone) {
        _data.delete('users', phone, function(err) {
            if(!err) {
                callback(200, {'status correct': 'the user was deleted correctly'})
            } else {
                callback(400, {'Error': "Coul not delete the specified user"} );
            }
        })
    } else {
